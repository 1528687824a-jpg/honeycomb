...
const capabilities: RuntimeCapability[] = [
  {
    ...
    routes: [
      ...
      "GET /jobs/:jobId/artifact-files/:artifactFileId/content",
      "GET /jobs/:jobId/deliveries",
      "POST /jobs/:jobId/deliveries/:deliveryId/claim",
      "POST /jobs/:jobId/deliveries/:deliveryId/complete",
      "POST /jobs/:jobId/deliveries/:deliveryId/fail",
      "POST /jobs/:jobId/deliveries/finalize",
    ...
    implemented: [
      ...
      "Validated document artifacts with deterministic MD/TXT/JSON/CSV/DOCX/PDF generation and OOXML/PDF parsing",
      "Canonical artifact records with format, byte count, dimensions when applicable, source, and SHA-256",
      ...
      "Cross-platform path boundary checks, revocation, and destination-bound completion receipts",
      "Atomic native desktop writes before final task success",
  ...
  },
  {
    ...
    implemented: [
      ...
      "Expired model-call lease summary and concurrency-safe recovery scan",
      "Job heartbeat summary",
      "Stalled-job heartbeat scan",
      "Leader-safe automatic heartbeat and expired model-call maintenance",
  ...
  },
  {
    ...
    implemented: [
      ...
      "Custom artifact destinations require a separate persisted approval grant",
      "Network/device paths and unapproved destination traversal are blocked",
